...
module "idr-ansible" {
  ...
  #ansible_playbooks = "idr-playbooks/os-idr-volumes.yml idr-playbooks/idr.yml"
  ansible_playbooks = "idr-playbooks/os-idr-volumes.yml idr-playbooks/idr.yml idr-playbooks/utils-reset-public-password.yml idr-playbooks/idr-docker.yml"
